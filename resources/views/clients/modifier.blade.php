...
@section('content')
    <div class="card border border-raduis">
        <div class="card card-header text-white bg-success border-raduis">
            <h3 class="text-center text-white fw-bold">Modification des clients</h3>
        </div>
        <div class="row mt-4">
            ...
            <div class="col-2 form-group">
                <a href="{{route('create.client')}}" class="btn btn-info bg-success ml-auto text-white ">Nouveau client<i class="fa fa-plus"></i></a>
            </div>
        </div>
